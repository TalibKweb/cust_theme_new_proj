...
<section class="homeBanner">
    <div class="container-fluid p-0">
        <div class="innerSlide">
            <img src="<?php echo get_template_directory_uri(); ?>/images/commercial-1.jpg" class="img-fluid w-100" />
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center links">
            <ul class="d-flex align-items-center mb-0 ps-0">
                <li><a href="<?php echo site_url() ?>/projects-page">All</a></li>
                <li><a class="fw-bold" href="<?php echo site_url() ?>/project-category/residential/">RESIDENTIAL</a></li>
